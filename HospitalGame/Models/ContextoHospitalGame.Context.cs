...
namespace HospitalGame.Models
{
    ...
    public partial class ContextoHospitalGame : DbContext
    {
        ...
        public virtual int INSERTARRANKING(Nullable<int> idUsuario, string nombre, string apellidos, string usuario, string pass)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("INSERTARRANKING", idUsuarioParameter, nombreParameter, apellidosParameter, usuarioParameter, passParameter);
        }
    }
}
